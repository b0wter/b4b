...
statToString stat =
    case stat of
        ...
        OffensiveAccessoryCount ->
            "offensive accessory count"

        QuickAccessoryCount ->
            "quick accessory count"

        SupportAccessoryCount ->
            "support accessory count"
        ...
        BulletStumble ->
            "bullet stumble damage"

        MeleeStumble ->
            "melee stumble damage"
            ...
            let
                d =
                    case duration of
                        ...
                        ForSeconds s ->
                            "after " ++ (s |> String.fromInt) ++ " seconds"
            in
