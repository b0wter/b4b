...
var $author$project$Main$Property = function (description) {
	return {description: description};
};
var $author$project$Main$dummyCard = {
	properties: _List_fromArray(
		[
			$author$project$Main$Property('foo'),
			$author$project$Main$Property('bar')
		]),
	title: 'Dummy Card'
};
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{
			cardPool: _List_fromArray(
				[$author$project$Main$dummyCard, $author$project$Main$dummyCard, $author$project$Main$dummyCard]),
			selectedCards: _List_Nil
		},
...
var $author$project$Main$header = function (model) {
	return A2($rundis$elm_bootstrap$Bootstrap$Grid$row, _List_Nil, _List_Nil);
};
...
var $author$project$Main$cardView = function (model) {
		...
		A3(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Some description, bla bla bla')
						])),
...
var $author$project$Main$cardPoolView = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Main$cardView, model.cardPool));
};
